...
\author{Dylan McClish\thanks{Working paper -- comments welcome. Draft of \today.}}
...
\begin{quote}
\small
\noindent\textbf{AI Disclosure.} The text of this paper was written by the author without the assistance of AI tools. AI coding assistants were used during the development of the accompanying codebase (available at \url{https://github.com/dylanmcclish/rl-market-making-qr-impact}), including implementation, debugging, and code review.
\end{quote}
